...
@Module({
  imports: [
    ...
    TypeOrmModule.forFeature([ContactUs, MatchedDuosNotifications, MatchedDuos, User, UserDetails, AccountAbuseReport]),
    UsersModule,
    AuthModule,
    MailModule,
    SeederModule,
  ...
  providers: [MatchedDuosService, NotificationsService, AppService, ContactUsService, ReportsService, ResponseBody],
  exports: [],
})
